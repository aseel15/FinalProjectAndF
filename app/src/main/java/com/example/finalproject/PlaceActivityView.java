...
public class PlaceActivityView extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_parties);
...
//                                ));
                            ...
                            recyclerView.setLayoutManager(new LinearLayoutManager(PlaceActivityView.this));
                            PlaceAdapter adapter = new PlaceAdapter(PlaceActivityView.this, placeList);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.nav_home:
                intent=new Intent(PlaceActivityView.this, MainActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_services:
                intent=new Intent(PlaceActivityView.this, ServiceActivityCustomer.class);
                startActivity(intent);
                break;
            case R.id.nav_trips:
                intent=new Intent(PlaceActivityView.this, TripList.class);
                startActivity(intent);
                break;
            case R.id.nav_person:
                intent=new Intent(PlaceActivityView.this, Profile.class);
                startActivity(intent);
                break;
            case R.id.nav_wedding:
                intent=new Intent(PlaceActivityView.this, APIActivity.class);
                startActivity(intent);
                break;
            case R.id.nav_logout:
                intent=new Intent(PlaceActivityView.this, LogOut.class);
                startActivity(intent);
                break;
            case R.id.nav_parties:
                intent=new Intent(PlaceActivityView.this, PlacesEmployeeView.class);
                startActivity(intent);
                break;
        }
        drawerLayout.closeDrawer(GravityCompat.START);
    ...
    public void btnSearchOnClick(View view) {
        ...
        for (int i = 0; i < placeList.size(); i++) {
            ...
            recyclerView.setLayoutManager(new LinearLayoutManager(PlaceActivityView.this));
            PlaceAdapter adapter = new PlaceAdapter(PlaceActivityView.this, roomsFiltered);
            recyclerView.setAdapter(adapter);
        }
    ...
    public void getReservedPlaces(){
        ...
        StringRequest request=new StringRequest(Request.Method.GET, string_Url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Toast.makeText(PlaceActivityView.this, "tru",
            ...
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(PlaceActivityView.this, error.toString(),
                        Toast.LENGTH_SHORT).show();
